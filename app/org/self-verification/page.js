  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 px-4 sm:px-6 md:px-10 py-6">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex justify-between items-center flex-wrap gap-4">
          <div>
            <h1 className="text-3xl font-bold text-[#ff004f]">
              Organization Candidate Verification
            </h1>
            <p className="text-gray-600 mt-1">
              Select checks and initiate verification workflow.
            </p>
          </div>
        ...
        {/* CANDIDATE SELECT (ORG DROPDOWN REMOVED) */}
        <div className="bg-white p-6 rounded-xl shadow border">
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              <label className="text-sm font-medium">Organization</label>
              <div className="border p-2 rounded bg-gray-100 text-gray-600 mt-1">
